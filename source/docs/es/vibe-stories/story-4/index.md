---
title: "Este portafolio: cuatro idiomas, un repo"
description: "La metahistoria: cómo este sitio fue especificado, clonado del sistema de diseño de easy-vibe, traducido a cuatro idiomas y enviado por un equipo de agentes."
---

# Este portafolio: cuatro idiomas, un repo

Estás viendo el proyecto más autorreferencial de mi portafolio: **este sitio web**. Es una reconstrucción fiel del sistema de diseño de [easy-vibe](https://datawhalechina.github.io/easy-vibe/en/) — el mismo tema VitePress, layout y comportamiento — con cada texto e imagen reemplazados por mi propio contenido, en **cuatro idiomas**: English, فارسی, العربية y Español.
...
- **Cuatro locales con RTL** — persa y árabe voltean tipografía, padding, iconos y dirección del carrusel; solo los bloques de código quedan LTR.
